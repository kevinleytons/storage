...
<head>
    ...
    <title>Nueva Venta | Storage System</title>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">                    	
                        <h1 class="page-head-line">Nueva Venta</h1>
                        <h1 class="page-subhead-line">Ingrese datos para realizar nueva venta</h1>
                    </div>
                </div><!-- /. ROW  -->
                ...
                <form action="#" method="post" runat="server">
                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-8 col-sm-8">
                            <div class="form-group">
                                <label>Cliente:</label>
                                <asp:TextBox id="cliente" type="text" class="form-control" runat="server"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-4">
                            <div class="form-group">
                                <label>Tipo Documento:</label>
                                <asp:DropDownList id="documento" class="form-control" runat="server"></asp:DropDownList>
                            </div>
                        </div>
                    </div>
