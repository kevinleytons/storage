<%@ Page Language="C#" Src="bin/Controllers/Productos.aspx.cs" Inherits="Controllers.Productos" %>
<!DOCTYPE html>
            ...
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">                    	
                        ...
                        <h1 class="page-subhead-line">Lista Con Todas Las Ventas Realizadas</h1>
                    </div>
                </div><!-- /. ROW  -->
